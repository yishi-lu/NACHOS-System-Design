...
const int StackSize = (100 * 1024);	// in words
...
// while executing kernel code.
  ...
  public:
    ...
    //variable which is used to track parent of this thread
    Thread* parent = NULL;

    //thred ID
    int threadID;

    //child thread ID, this thread is waiting for the child thread finish
    int childID = -1;

    //list which is used to track child threads of this thread
